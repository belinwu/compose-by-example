...
object Dep {
    ...
    const val coreVersion = "1.6.0-rc01"
    ...
    const val pagingVersion = "3.1.0-alpha01"
    const val roomVersion = "2.4.0-alpha03"
    const val securityCryptoVersion = "1.1.0-alpha03"
    const val sqliteVersion = "2.2.0-alpha01"
    const val testVersion = "1.3.0"
    const val windowVersion = "1.0.0-alpha08"
    ...
    const val pagingCompose = "androidx.paging:paging-compose:1.0.0-alpha10"
    ...
    const val kotlinStdlibJvm8 = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:$kotlinVersion"
    ...
    const val accompanistPlaceholderMaterial = "com.google.accompanist:accompanist-placeholder-material:$accompanistVersion"
